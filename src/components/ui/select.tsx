/**
 * Select component for Client Tracker (Client Component).
 * Provides dropdown menus for selecting options (e.g., pitch decks, strategies in ClientModal).
 * Why: Enables accessible, styled dropdowns using Radix UI and Tailwind, per shadcn/ui standards.
 * How: Wraps Radix Select primitives with Tailwind styles for consistent UI.
 */
"use client";
